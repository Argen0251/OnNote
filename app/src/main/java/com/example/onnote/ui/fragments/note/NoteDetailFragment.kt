    ...
    class NoteDetailFragment : Fragment(), OnClickIten {
        ...
        private fun showColorPickerDialog(anchorView: View) {
            ...
            dialogView.findViewById<View>(R.id.color4).setOnClickListener {
                updateBackgroundColor(ContextCompat.getColor(requireContext(), R.color.purple))
                dialog.dismiss()
            }
            dialogView.findViewById<View>(R.id.color5).setOnClickListener {
                updateBackgroundColor(ContextCompat.getColor(requireContext(), R.color.yellaw))
                dialog.dismiss()
            }
            ...
            if (window != null) {
                ...
                layoutParams.width = 158.dpToPx(requireContext())
